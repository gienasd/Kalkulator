...
public class Main {
    ...
    private static void parseChoice(int choice) {
        ...
        switch (choice) {
            ...
            default: System.out.println("Nie znam takiej komendy, proszę podaj poprawną liczbę!");
        }
    }
    ...
    private static void parseSecondChoice(double result){
        int secondChoice;
        do {
            printSecondMenu();
            secondChoice = Integer.parseInt(scanner.nextLine());
            switch (secondChoice) {
                case 1: { memory.add(result); } break;
                ...
                default: System.out.println("Nie znam takiej komendy!");
            }
