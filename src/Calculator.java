public class Calculator implements ICalculations {
    ...
    @Override
    public double substract(int a, int b) { return a - b; }
    @Override
    ...
    @Override
    public double root(int a) { return Math.sqrt(a); }
    @Override
    public double angleToRadian(int a) { return Math.toRadians(a); }
    @Override
    public double sinus(int a) { return Math.sin(a); }
    @Override
    public double cosinus(int a) { return Math.cos(a); }
    @Override
    public double tangens(int a) { return Math.tan(a); }
    @Override
    public double arcsinus(double a) { return Math.asin(a); }
    @Override
    public double arccosinus(double a) { return Math.acos(a); }
    @Override
    public double arctangens(double a) { return Math.atan(a); }
    @Override
